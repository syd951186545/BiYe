...
class DQN:
    ...
    def __init__(self):
        ...
        self.memory = []
        self.optimizer = optim.Adam(self.act_net.parameters(), self.learning_rate/self.batch_size)
...
if __name__ == '__main__':
    ...
    agent.update()
    torch.save(agent.act_net.state_dict(), config.act_net_model_dir + "final.model")
